...
export const themes: Record<ThemeName, ThemeConfig> = {
  ...
  modern: {
    ...
    personalInfo: {
      ...
      gridClass: "flex flex-row items-center gap-6 mt-4",
      infoContainerClass: "flex-1",
      avatarContainerClass: "w-20 h-20 overflow-hidden rounded-full border-2 border-white flex-shrink-0",
      contactContainerClass: "grid grid-cols-2 gap-x-6 gap-y-2 mt-3",
      contactItemClass: "text-sm text-white flex items-center space-x-2",
