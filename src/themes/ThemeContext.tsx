...
export const themes: Record<ThemeName, ThemeConfig> = {
  ...
  modern: {
    ...
    personalInfo: {
      ...
      gridClass: "flex flex-col-reverse md:flex-row items-start md:items-center justify-between gap-8 mt-6",
      infoContainerClass: "flex-1 min-w-0",
      avatarContainerClass: "w-28 h-28 overflow-hidden border border-[#9b72d1]/50 bg-[#1e293b] z-20 rounded-sm shadow-md shrink-0",
      contactContainerClass: "grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 mt-8 pt-6 border-t border-[#f1f5f9]/10",
      contactItemClass: "text-sm text-[#f1f5f9]/80 flex items-center space-x-3 font-mono min-w-0",
      labelClass: "text-[#9b72d1] uppercase text-xs w-16 shrink-0",
      valueClass: "text-[#f1f5f9] break-all flex-1 min-w-0",
    },
    section: {
