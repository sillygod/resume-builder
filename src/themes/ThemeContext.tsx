...
export const themes: Record<ThemeName, ThemeConfig> = {
  ...
  executive: {
    ...
    personalInfo: {
      ...
      contactContainerClass: "grid grid-cols-1 gap-y-4 gap-x-8 mt-8 pt-8 border-t border-[#f1f5f9]/10",
      contactItemClass: "text-sm text-[#f1f5f9]/80 flex items-center space-x-4 font-mono break-all",
