...
export const themes: Record<ThemeName, ThemeConfig> = {
  ...
  simple: {
    ...
    personalInfo: {
      ...
      avatarContainerClass: "w-24 h-24 overflow-hidden border border-[#3bd4f5]/50 p-1 bg-[#3bd4f5]/5 rounded-sm",
      contactContainerClass: "mt-6 grid grid-cols-2 gap-y-3",
      contactItemClass: "text-xs text-[#f1f5f9]/80 flex items-center font-mono",
      labelClass: "font-medium text-[#3bd4f5]/70 uppercase w-20 tracking-wider",
  ...
  executive: {
    ...
    personalInfo: {
      containerClass: "relative bg-[#151922] p-12 border-l-4 border-[#3bd4f5] shadow-sm",
      titleClass: "text-4xl md:text-5xl font-display font-light text-[#f1f5f9] tracking-wider mb-2",
      subtitleClass: "text-base font-tech text-[#3bd4f5] tracking-[0.3em] uppercase",
      gridClass: "flex flex-col md:flex-row items-center md:items-start gap-12 mt-8",
      infoContainerClass: "flex-1 space-y-6 w-full",
      avatarContainerClass: "w-36 h-36 overflow-hidden border border-[#3bd4f5]/30 p-1 bg-[#3bd4f5]/5 rounded-sm",
      contactContainerClass: "grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 mt-8 pt-8 border-t border-[#f1f5f9]/10",
      contactItemClass: "text-sm text-[#f1f5f9]/80 flex items-center space-x-4 font-mono",
      labelClass: "text-[#3bd4f5]/60 uppercase tracking-widest text-xs w-20",
      valueClass: "text-[#f1f5f9] font-light",
    },
    section: {
    ...
    workExperience: {
      ...
      titleClass: "text-xl font-display font-light text-[#f1f5f9] uppercase tracking-[0.25em] mb-8 pb-4 border-b border-[#f1f5f9]/10 relative flex items-center before:content-[''] before:w-2 before:h-2 before:bg-[#3bd4f5] before:mr-4",
      entryClass: "relative grid grid-cols-1 lg:grid-cols-[1fr_3fr] gap-8 mb-10",
      ...
      periodClass: "text-sm font-mono text-[#f1f5f9]/50 lg:text-right w-full block",
      descriptionClass: "text-sm text-[#f1f5f9]/80 leading-relaxed font-light",
    },
    education: {
      containerClass: "relative mt-12",
      titleClass: "text-xl font-display font-light text-[#f1f5f9] uppercase tracking-[0.25em] mb-8 pb-4 border-b border-[#f1f5f9]/10 relative flex items-center before:content-[''] before:w-2 before:h-2 before:bg-[#3bd4f5] before:mr-4",
      entryClass: "relative grid grid-cols-1 lg:grid-cols-[1fr_3fr] gap-8 mb-8",
